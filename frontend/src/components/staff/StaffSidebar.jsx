...
const STAFF_NAV_SECTIONS = [
  {
    title: "Workspace",
    items: [
      { to: ROUTES.STAFF_DASHBOARD, label: "Overview", end: true },
      { to: ROUTES.STAFF_OPERATIONS, label: "Staff operations", end: true },
      { to: ROUTES.STAFF_CARGO, label: "Cargo", end: true },
    ],
  },
];

export function StaffSidebar({ open, onClose, theme }) {
      ...
      >
        ...
        >
          <NavLink
            ...
            onClick={handleNav}
          >
            Menahariya <span className="text-secondary-400">Staff</span>
          </NavLink>
          <button
            type="button"
            className={cn(
