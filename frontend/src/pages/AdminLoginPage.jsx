...
const ADMIN_PHONE_MAX_DIGITS = 12;
const ADMIN_PHONE_STANDARD_ERROR =
  "Use a valid Ethiopian phone number: 09XXXXXXXX or 2519XXXXXXXX.";

function isAdminPhoneStandard(value) {
...
export function AdminLoginPage() {
  ...
  const validatePhone = (value) => {
    ...
    setPhoneError(
      isAdminPhoneStandard(normalized) ? "" : ADMIN_PHONE_STANDARD_ERROR
    );
  };
  ...
  async function handleSubmit(e) {
    ...
    if (!isAdminPhoneStandard(phoneValue)) {
      setPhoneError(ADMIN_PHONE_STANDARD_ERROR);
      setError(ADMIN_PHONE_STANDARD_ERROR);
      return;
    }
    setPhoneError("");
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <Input
              ...
              inputMode="numeric"
              pattern="[0-9]*"
              maxLength={ADMIN_PHONE_MAX_DIGITS}
              autoComplete="tel"
              value={phone}
              ...
              onBlur={() => {
                ...
                setPhoneError(
                  isAdminPhoneStandard(normalized)
                    ? ""
                    : ADMIN_PHONE_STANDARD_ERROR
                );
              }}
