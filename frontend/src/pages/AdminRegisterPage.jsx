...
export function AdminRegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (!/[A-Za-z]/.test(nameTrim)) {
      setError("Full name must contain letters.");
      return;
    }
  ...
  return (
    <AuthShell
      ...
      panelSubtitle="Use your phone number to sign in after registration. Use a strong password — required for admin access."
      footer={
        <AuthFooterLinks
