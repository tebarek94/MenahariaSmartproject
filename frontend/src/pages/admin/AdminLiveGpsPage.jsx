    ...
    <div className="w-full min-w-0 space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-primary-400/85 sm:text-base">
          Positions update in real time while a driver has{" "}
          <strong className="text-primary-300/95">Start sharing</strong> enabled on{" "}
          <strong className="text-primary-300/95">Driver → Share location</strong>. When they tap{" "}
          <strong className="text-primary-300/95">Stop sharing</strong> (or close that page), their marker
          disappears here.{" "}
          <a
      ...
      <Card
        title="Drivers currently sharing"
        subtitle="Last position per driver while sharing is on (in-memory; cleared when the driver stops or if the API restarts)"
      >
        {driverList.length === 0 ? (
