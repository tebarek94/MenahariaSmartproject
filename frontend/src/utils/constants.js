 ...
 * app), which keeps `Authorization` reliable. Socket.IO may use `VITE_SOCKET_URL` or defaults to backend :5000 in dev.
 */
...
/** DB `roles.id` for driver row (default seed: 2 = driver). */
export const DRIVER_ROLE_ID =
  Number(import.meta.env.VITE_DRIVER_ROLE_ID) || 2;
export const STAFF_ROLE_ID =
  Number(import.meta.env.VITE_STAFF_ROLE_ID) || 4;
...
export const ROUTES = {
  ...
  ADMIN_DRIVER_ASSIGNMENTS: "/admin/driver-assignments",
